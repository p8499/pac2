...
class UniquesController : Controller() {
    override val root: Node get() = anchor
    @FXML private lateinit var anchor: AnchorPane
    @FXML private lateinit var table: TableView<Unique>
    @FXML private lateinit var columnItems: TableColumn<Unique, String>
    @FXML private lateinit var columnKey: TableColumn<Unique, Boolean>
    @FXML private lateinit var columnSerial: TableColumn<Unique, Boolean>
    val core: ObservableList<Unique> get() = scene["core"]
    ...
    override fun initialize(location: URL?, resources: ResourceBundle?) {
        ...
        columnItems.setCellValueFactory { SimpleStringProperty(it.value.items.joinToString(", ")) }
        columnKey.setCellValueFactory { it.value.keyProperty }
        columnSerial.setCellValueFactory { it.value.serialProperty }
    }
