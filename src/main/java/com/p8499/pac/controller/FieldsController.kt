...
class FieldsController : Controller() {
    ...
    @FXML private lateinit var table: TableView<Field>
    @FXML private lateinit var columnSource: TableColumn<Field, String>
    @FXML private lateinit var columnDatabaseColumn: TableColumn<Field, String>
    @FXML private lateinit var columnDescription: TableColumn<Field, String>
    @FXML private lateinit var columnNotNull: TableColumn<Field, Boolean>
    @FXML private lateinit var columnJavaType: TableColumn<Field, String>
    @FXML private lateinit var columnDefaultValue: TableColumn<Field, String>
    val core: ObservableList<Field> get() = scene["core"]
    ...
    override fun initialize(location: URL?, resources: ResourceBundle?) {
        ...
        columnSource.setCellValueFactory { it.value.sourceProperty }
        columnDatabaseColumn.setCellValueFactory { it.value.databaseColumnProperty }
        columnDescription.setCellValueFactory { it.value.descriptionProperty }
        columnNotNull.setCellValueFactory { it.value.notNullProperty }
        columnJavaType.setCellValueFactory { it.value.javaTypeProperty }
        columnDefaultValue.setCellValueFactory { it.value.defaultValueProperty }
    }
